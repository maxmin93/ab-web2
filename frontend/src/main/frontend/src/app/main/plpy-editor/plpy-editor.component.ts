...
export class PlpyEditorComponent implements OnInit {
  ...
  ngOnInit() {    
    gtag('set', {'page_title':'pyeditor', 'page_path':'/pyeditor', 'screen_name':'pyeditor'});
    ...
    // **NOTE: "Error: formGroup expects a FormGroup instance. Please pass one in."
    //        ==> even if put 'formControlName' into html, Error comes out.
    //        ==> ignore!!
    //
    // this.procFormGrp = this._fb.group({
  ...
  onSelect({ selected }) {    // same to this.selected
    gtag('event', 'tap_row', {'event_category':'pyeditor', 'event_label':'table'});
  ...
  newPlpy(){
    gtag('event', 'new_plpy', {'event_category':'pyeditor', 'event_label':'toolbar'});
  ...
  savePlpy(){
    gtag('event', 'save_plpy', {'event_category':'pyeditor', 'event_label':'toolbar'});
  ...
  deletePlpy(){
    gtag('event', 'delete_plpy', {'event_category':'pyeditor', 'event_label':'toolbar'});
